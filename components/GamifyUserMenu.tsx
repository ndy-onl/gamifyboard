...
import { Button } from "@excalidraw/excalidraw/components/Button"; // ADDED IMPORT
import "@excalidraw/excalidraw/components/live-collaboration/LiveCollaborationTrigger.scss"; // ADDED IMPORT
...
export const GamifyUserMenu: React.FC<GamifyUserMenuProps> = ({
  ...
  const handleSelectBoard = async (boardId: string) => {
    ...
    try {
      ...
      if (boardData && boardData.elements && boardData.appState) {
        ...
        const loadedAppState = { ...boardData.appState, collaborators: new Map(Object.entries(boardData.appState.collaborators || {})) };
  ...
  return (
    <div style={{ position: "relative" }}>
      {auth.accessToken ? (
        <>
          <Button className="collab-button" // ADDED className
